            ...
            if (allreadyCalculated == true)
            {
                ...
                if (addTorques)
                {
                    for (int i = 0; i < splinters.Count; i++)
                    {
                        ...
                        if (splinters[i].GetComponent<Rigidbody>()) splinters[i].GetComponent<Rigidbody>().AddTorque(new Vector3(Random.value > 0.5f ? Random.value * 50 : -Random.value * 50, Random.value > 0.5f ? Random.value * 50 : -Random.value * 50, Random.value > 0.5f ? Random.value * 50 : -Random.value * 50));
                        else splinters[i].AddComponent<Rigidbody>().AddTorque(new Vector3(Random.value > 0.5f ? Random.value * 50 : -Random.value * 50, Random.value > 0.5f ? Random.value * 50 : -Random.value * 50, Random.value > 0.5f ? Random.value * 50 : -Random.value * 50));;
                    }
                }
            }
            else
